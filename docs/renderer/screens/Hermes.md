...
- 左栏 Sidebar：Chat / Sessions / models / skills / tools / memory / providers 导航
- 中栏：当前选中页面内容
...
| `pages/Chat/` | Chat 页面（WebChat Surface） |
...
- 固定 `default` profile，不切换 Profile
